package fr.umlv.hanabi.graphic;
...
import fr.umlv.hanabi.mvc.SimpleGameView;
...
public class GraphicsData {
	...
	public final static int boardCardWidth = (int) (215 * SimpleGameView.RATIO_WIDTH);
	public final static int boardCardHeight = (int) (300 * SimpleGameView.RATIO_HEIGHT);
	public final static int boardCardPosX = (int) (650 * SimpleGameView.RATIO_WIDTH);
	public final static int boardCardPosY = (int) (80 * SimpleGameView.RATIO_HEIGHT);
	
	public final static int discardCardWidth = (int) (179 * SimpleGameView.RATIO_WIDTH);
	public final static int discardCardHeight = (int) (250 * SimpleGameView.RATIO_HEIGHT);
	
	public final static int coinsSize = (int) (75 * SimpleGameView.RATIO_WIDTH);
	public final static int coinsPosY = (int) (590 * SimpleGameView.RATIO_HEIGHT);
	public final static int coinsPosX = (int) (SimpleGameView.getWidth() - (coinsSize + 10 * SimpleGameView.RATIO_WIDTH));
	
	public final static int playersCardWidth = (int) (108 * SimpleGameView.RATIO_WIDTH);
	public final static int playersCardHeight = (int) (150 * SimpleGameView.RATIO_HEIGHT);
	public final static int playersCardPosX = (int) (112 * SimpleGameView.RATIO_WIDTH);
	public final static int playersCardPosY = (int) (155 * SimpleGameView.RATIO_HEIGHT);
	
	public final static int currentCardWidth = (int) (215 * SimpleGameView.RATIO_WIDTH);
	public final static int currentCardHeight = (int) (300 * SimpleGameView.RATIO_HEIGHT);
	public final static int currentCardPosY = (int) (780 * SimpleGameView.RATIO_HEIGHT);
	
	public final static int buttonWidth = (int) (128 * SimpleGameView.RATIO_WIDTH);
	public final static int buttonHeight = (int) ((buttonWidth / 2));
	public final static int buttonPosX = (int) (9 * SimpleGameView.RATIO_WIDTH);
	public final static int buttonPosY = (int) ((currentCardPosY - (100 * SimpleGameView.RATIO_HEIGHT - buttonHeight) / 2) + currentCardHeight / 2 - buttonHeight);
	
	public final static float menuWidth = (float) SimpleGameView.getWidth() / 5;
	public final static float menuHeight = (float) (3 * SimpleGameView.getHeight()) / 5;
	public final static float menuPosX = (float) (2 * SimpleGameView.getWidth()) / 5;
	public final static float menuPosY = (float) SimpleGameView.getHeight() / 5;
	
	public final static int menuButtonWidth = (int) ((GraphicsData.menuWidth - 20 * SimpleGameView.RATIO_WIDTH));
	public final static int menuButtonHeight = (int) (113 * SimpleGameView.RATIO_HEIGHT);
	public final static int menuButtonPosX = (int) ((GraphicsData.menuPosX + 10 * SimpleGameView.RATIO_WIDTH));
	...
	private static BufferedImage initCardBack() throws IOException {
		InputStream input = ClassLoader.getSystemResourceAsStream("resources/Card/Card_Back.png");
